...
class FoodItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_item" do
    assert_difference('FoodItem.count') do
      post food_items_url, params: { food_item: { available: @food_item.available, catering: @food_item.catering, description: @food_item.description, featured: @food_item.featured, price: @food_item.price, title: @food_item.title } }
    end
  ...
  test "should update food_item" do
    patch food_item_url(@food_item), params: { food_item: { available: @food_item.available, catering: @food_item.catering, description: @food_item.description, featured: @food_item.featured, price: @food_item.price, title: @food_item.title } }
